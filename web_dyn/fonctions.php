...
function pageheader(){
    ...
    <div class="col-sm-4 logo">
        <img src="images/bugs.png" class="img-fluid" style="height:10vh;">
    </div>
    <div class="col-lg-6 col-sm-5 display-4">
        Site Web Dynamique
    </div>
    <div class="col-sm-2">';
...
function pagenavbar($pageactive){
    ...
    <ul class="navbar-nav mr-auto">';
        ...
        echo '
        <li class="nav-item">
        <a class="nav-link '.($pageactive == "page07.php" ? "fw-semibold active border border-2 rounded-3 border-light bg-gradient" :"").'" href="page07.php">Autre</a>
        </li>
    </ul>';
