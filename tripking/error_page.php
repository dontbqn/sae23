...
?>
    ...
    <body>
        ...
        // Display the personalized error message
        echo '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-exclamation-triangle mb-1" viewBox="0 0 16 16">
                        ...
                        </svg>  Aucun espace perso existant à ce nom <br/><br/>';

        echo '</div>
        <a class="btn mt-2 border-dark border-1 bg-dark link-light text-decoration-none" href="./page01.php">
